 ...
 */
public class T_cate_mainVo implements Serializable{

	public static final String TABLE = "T_CATE_MAIN";
	...
	* Constractor
	*/
	public T_cate_mainVo(){}

	/**
	* Constractor
	* @param <code>maincode</code>
	*/
	public T_cate_mainVo(String maincode){
